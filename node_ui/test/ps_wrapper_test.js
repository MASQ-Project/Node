...
describe('ps_wrapper', function () {
  ...
  describe('killNodeProcess', function () {
    it('should not call treeKill with wrong path', async function () {
    ...
    it('kills with *nix path', async function () {
      td.when(mockPs()).thenResolve([{
        name: 'SubstratumNode',
    ...
    it('kills with Windows path', async function () {
      td.when(mockPs()).thenResolve([{
        name: 'SubstratumNode',
        cmd: 'users\\static\\binaries\\SubstratumNode --dns_servers 8.8.8.8',
        pid: '1234'
  ...
  describe('findNodeProcess', function () {
    it('should not find with *nix path', async function () {
      td.when(mockPs()).thenResolve([{
        name: 'SubstratumNode',
        cmd: 'users/SubstratumNode --dns_servers 8.8.8.8'
      }])
    ...
    it('should find with *nix path', async function () {
      td.when(mockPs()).thenResolve([{
        name: 'SubstratumNode',
        cmd: 'users/static/binaries/SubstratumNode --dns_servers 8.8.8.8'
      }])
    ...
    it('should find with Windows path', async function () {
      td.when(mockPs()).thenResolve([{
        name: 'SubstratumNode',
        cmd: 'users\\static\\binaries\\SubstratumNode --dns_servers 8.8.8.8'
      }])
