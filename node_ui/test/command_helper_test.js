...
describe('CommandHelper', function () {
  ...
  describe('Unix Platforms', function () {
    ...
    describe('starting on linux', function () {
      const command = /[/\\]static[/\\]scripts[/\\]substratum_node\.sh uid gid .*[/\\]static[/\\]binaries[/\\]linux[/\\]node --dns_servers \d.*/
    ...
    describe('starting on mac', function () {
      const command = /[/\\]static[/\\]scripts[/\\]substratum_node\.sh uid gid .*[/\\]static[/\\]binaries[/\\]mac[/\\]node --dns_servers \d.*/
  ...
  describe('Windows Platform', function () {
    ...
    describe('starting', function () {
      const command = /[/\\]static[/\\]scripts[/\\]substratum_node\.cmd .*[/\\]static[/\\]binaries[/\\]win[/\\]node --dns_servers \d.*/
