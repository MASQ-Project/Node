...
type StandardBroadcastSpawner = Box<dyn FnOnce() -> Box<dyn BroadcastHandle<MessageBody>>>;
...
struct LaunchPlatform {
    ...
    spawn_standard_broadcast_handler: StandardBroadcastSpawner,
    spawn_cms_event_loop: CMSLoopSpawner,
}
