...
use crate::run_modes::InitArgsCheck;
...
impl InitialArgsParser for InitialArgsParserReal {
    async fn parse_initialization_args(
        ...
        InitArgsCheck::EnterApp(InitializationArgs::new(ui_port))
    }
}
