...
describe('Renderer', () => {
  ...
  beforeEach(() => {
    ...
    mockNodeActuator = td.replace('../src/render-process/node_actuator')
    mockSettings = td.replace('../src/render-process/settings')
    mockDocument = td.replace('../src/wrappers/document_wrapper')
    ...
    require('../src/render-process/renderer')
  })
