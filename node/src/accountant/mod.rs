...
mod tests {
    ...
    #[actix::test]
    async fn accountant_handles_config_change_msg() {
    ...
    #[actix::test]
    async fn externally_triggered_scan_payables_request() {
    ...
    #[actix::test]
    async fn sent_payables_with_response_skeleton_results_in_scan_response_to_ui_gateway() {
        ...
        subject_addr.send(sent_payables).await.unwrap();
    ...
    #[actix::test]
    async fn qualified_payables_under_our_money_limit_are_forwarded_to_blockchain_bridge_right_away() {
    ...
    #[actix::test]
    async fn qualified_payables_over_masq_balance_are_adjusted_before_sending_to_blockchain_bridge() {
        // The numbers in balances don't do real math, they don't need to match either the condition for
        // the payment adjustment or the actual values that come from the payable size reducing algorithm;
        // all that is mocked in this test
        init_test_logging();
    ...
    #[actix::test]
    async fn externally_triggered_scan_identifies_all_pending_payables_as_complete() {
    ...
    #[actix::test]
    async fn externally_triggered_scan_for_new_payables_is_prevented_if_automatic_scans_are_enabled() {
    ...
    #[actix::test]
    async fn automatic_scan_for_new_payables_schedules_another_one_immediately_if_no_qualified_payables_found(
    ) {
    ...
    #[actix::test]
    async fn accountant_requests_blockchain_bridge_to_scan_for_received_payments() {
        init_test_logging();
        let (blockchain_bridge, _, blockchain_bridge_recording_arc) = make_recorder();
        let blockchain_bridge = blockchain_bridge
    ...
    #[actix::test]
    async fn accountant_processes_msg_with_received_payments_using_receivables_dao_and_then_updates_start_block(
    ) {
    ...
    #[actix::test]
    async fn accountant_scans_after_startup_and_does_not_detect_any_pending_payables() {
    ...
    fn periodical_scanning_for_payables_works() {
        ...
        let sent_tx = TxBuilder::default()
            ...
            payable_scan_type: PayableScanType::New,    response_skeleton_opt: None,
                };
    ...
    #[actix::test]
    async fn scan_for_new_payables_triggers_payment_for_balances_over_the_curve() {
        init_test_logging();
    ...
    #[actix::test]
    async fn scan_for_pending_payables_finds_various_payables() {
        init_test_logging();
