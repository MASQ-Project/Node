...
mod tests {
    ...
    use crate::test_utils::payable_dao_performance_utils::shared_test_environment::specialized_body_for_zig_zag_test;
    ...
    fn performance_test_for_mark_pending_payable_rowids_with_five_updates() {
        ...
        assert!(single_call_duration * cpu_coefficient / 10 < separate_calls_duration,
                "With multi-update machinery: {} μs, with a very simple call: {} μs; where the former is {} μs with {} % correction",
                single_call_duration.as_micros(),
                separate_calls_duration.as_micros(),
                ((single_call_duration * cpu_coefficient) / 10).as_micros(),
                cpu_coefficient * 10 - 100
        )
        //I've also often seen even better than 300 % but 120 % is safe for CI and CPU timing.
        //One here disregarded benefit is though that the first model does with only a single database call and so regarding
        //the number of thread synchronizations performed by the manager.
    }
    ...
    fn performance_test_for_mark_pending_payable_rowids_with_low_counts() {
        ...
        //
        // let (single_two, separate_two) = perform_with_counts_of_updates(5);
        //
        // let (single_two, separate_two) = perform_with_counts_of_updates(7);
        // /////////////////////////////////////////////////////////////////////////////////////////////////////
        // //TODO in Actions...
        // // single call: 858
        ...
        // eprintln!("github ratio 1: {}, ratio 2: {}", (858*100)/1124, (1791*100)/1139);
