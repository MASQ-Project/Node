...
use crate::blockchain::errors::{AppRpcError, BlockchainDbError, PreviousAttempts};
...
mod tests {
    ...
    fn failure_status_from_str_works() {
        ...
        assert_eq!(
            ...
            FailureStatus::RecheckRequired(ValidationStatus::Reattempting( PreviousAttempts::new(Box::new(AppRpcErrorKind::ServerUnreachable), &validation_failure_clock)))
        );
