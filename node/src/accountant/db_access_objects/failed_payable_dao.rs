...
// use crate::accountant::db_access_objects::sent_payable_dao::{Hash, RetrieveCondition, Tx, TxIdentifiers, TxUpdates};
...
// }
//
// pub enum FailureUpdate {}
//
// pub trait SentPayableDao {
//     fn get_tx_identifiers(&self, hashes: &HashSet<Hash>) -> TxIdentifiers;
//     fn insert_new_records(&self, txs: &[Tx]) -> Result<(), FailedPayableDaoError>;
//     fn retrieve_txs(&self, condition: Option<RetrieveCondition>) -> Vec<Tx>;
//     fn update_tx(&self, hash_map: FailureUpdate) -> Result<(), FailedPayableDaoError>;
...
//     }
//
//     fn update_tx(&self, hash_map: &TxUpdates) -> Result<(), FailedPayableDaoError> {
