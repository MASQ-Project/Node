...
use crate::blockchain::blockchain_interface::{ETH_MAINNET_CONTRACT_ADDRESS, MULTINODE_TESTNET_CONTRACT_ADDRESS, RINKEBY_TESTNET_CONTRACT_ADDRESS, ROPSTEN_TESTNET_CONTRACT_ADDRESS, POLYGON_MAINNET_CONTRACT_ADDRESS};
use itertools::Itertools;
use masq_lib::constants::{DEV_CHAIN_IDENTIFIER, ETH_MAINNET_IDENTIFIER, ETH_RINKEBY_IDENTIFIER, ETH_ROPSTEN_IDENTIFIER, MULTINODE_TESTNET_CONTRACT_CREATION_BLOCK, RINKEBY_TESTNET_CONTRACT_CREATION_BLOCK, ROPSTEN_TESTNET_CONTRACT_CREATION_BLOCK, ETH_MAINNET_CONTRACT_CREATION_BLOCK, POLYGON_MAINNET_CONTRACT_CREATION_BLOCK, POLY_MAINNET_IDENTIFIER};
...
impl Chain {
    pub fn record(&self) -> &BlockchainRecord {
        ...
        //untested panic - works as expect()
    }
...
mod tests {
    use super::*;
    use crate::blockchain::blockchain_interface::{POLYGON_MAINNET_CONTRACT_ADDRESS, MUMBAI_TESTNET_CONTRACT_ADDRESS};
    use masq_lib::constants::{POLYGON_MAINNET_CONTRACT_CREATION_BLOCK, MUMBAI_TESTNET_CONTRACT_CREATION_BLOCK};
