...
mod tests {
    ...
    #[actix::test]
    async fn blockchain_bridge_receives_bind_message() {
        init_test_logging();
    ...
    #[actix::test]
    async fn blockchain_interface_is_constructed_with_missing_blockchain_service_url() {
        init_test_logging();
    ...
    #[actix::test]
    async fn handles_initial_templates_msg_in_new_payables_mode_and_sends_response_back_to_accountant() {
        init_test_logging();
    ...
    #[actix::test]
    async fn process_payments_fails_on_get_transaction_count() {
    ...
    #[actix::test]
    async fn blockchain_bridge_processes_requests_for_a_complete_and_null_transaction_receipt() {
        let (accountant, _, accountant_recording_arc) = make_recorder();
        let accountant =
    ...
    #[actix::test]
    async fn handle_request_transaction_receipts_sends_back_results() {
        init_test_logging();
        let port = find_free_port();
    ...
    #[actix::test]
    async fn handle_retrieve_transactions_when_start_block_number_starts_undefined_in_a_brand_new_database(
    ) {
        let system = System::new(
    ...
    #[actix::test]
    async fn handle_retrieve_transactions_receives_invalid_topics() {
        init_test_logging();
    ...
    #[actix::test]
    async fn handle_retrieve_transactions_receives_query_failed_and_updates_max_block() {
        init_test_logging();
    ...
    #[actix::test]
    async fn handle_scan_future_handles_success() {
        let port = find_free_port();
        let _blockchain_client_server = MBCSBuilder::new(port)
