...
use crate::blockchain::blockchain_interface::{
    to_wei, BlockchainError, BlockchainTransaction, PayableTransactionError,
    RetrievedBlockchainTransactions, CONTRACT_ABI, TRANSACTION_LITERAL, TRANSFER_METHOD_ID,
};
...
pub struct BlockchainInterfaceSlim<T: BatchTransport + Debug> {
    logger: Logger, // *
    chain: Chain,   // *
...
impl<T> BlockchainInterfaceSlim<T>
where
...
mod tests {
    ...
    use crate::blockchain::blockchain_interface::{
        BLOCKCHAIN_SERVICE_URL_NOT_SPECIFIED, GWEI, REQUESTS_IN_PARALLEL,
    };
    ...
    #[test]
    fn blockchain_interface_slim_init() {
        ...
        let subject =
            BlockchainInterfaceSlim::new(transport, event_loop_handle, TEST_DEFAULT_CHAIN);
    }
    ...
    //     ) {
    //         todo!("GH-744 - Test this properly");
    //         // let sign_transaction_params_arc = Arc::new(Mutex::new(vec![]));
