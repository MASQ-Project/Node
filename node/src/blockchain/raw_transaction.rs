...
impl RawTransaction {
    ...
    pub fn sign(&self, wallet: &Wallet, chain: Chain) -> Vec<u8> {
        ...
        let sig = ecdsa_sign(&hash, wallet);
...
fn ecdsa_sign(hash: &dyn AsRef<[u8]>, wallet: &Wallet) -> Signature {
...
mod tests {
    ...
    fn signs_transaction_for_eth_mainnet() {
        let signatures = &[
            &[
                ...
                100, 0, 0, 128, 128, 160, 40, 239, 97, 52, 11, 217, 57, 188, 33, 149, 254, 83, 117,
            ...
            &[
                ...
                59, 154, 202, 0, 128, 128, 160, 9, 235, 182, 202, 5, 122, 5, 53, 214, 24, 100, 98,
    ...
    fn signs_transactions_for_poly_mainnet() {
        let signatures = &[
            &[
                248, 108, 9, 133, 4, 168, 23, 200, 0, 130, 82, 8, 148, 53, 53, 53, 53, 53, 53, 53,
                53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 136, 13, 224, 182, 179, 167,
                100, 0, 0, 128, 128, 160, 34, 13, 81, 82, 206, 70, 134, 49, 143, 10, 66, 79, 96,
            ...
            &[
                248, 106, 128, 134, 213, 86, 152, 55, 36, 49, 131, 30, 132, 128, 148, 240, 16, 159,
                200, 223, 40, 48, 39, 182, 40, 92, 200, 137, 245, 170, 98, 78, 172, 31, 85, 132,
                59, 154, 202, 0, 128, 128, 160, 106, 244, 39, 119, 163, 186, 125, 0, 250, 54, 66,
    ...
    fn signs_transaction_for_ropsten() {
        let signatures = &[
            &[
                248, 108, 9, 133, 4, 168, 23, 200, 0, 130, 82, 8, 148, 53, 53, 53, 53, 53, 53, 53,
                53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 136, 13, 224, 182, 179, 167,
                100, 0, 0, 128, 128, 160, 8, 220, 80, 201, 100, 41, 178, 35, 151, 227, 210, 85, 27,
            ...
            &[
                248, 106, 128, 134, 213, 86, 152, 55, 36, 49, 131, 30, 132, 128, 148, 240, 16, 159,
                200, 223, 40, 48, 39, 182, 40, 92, 200, 137, 245, 170, 98, 78, 172, 31, 85, 132,
                59, 154, 202, 0, 128, 128, 160, 186, 65, 161, 205, 173, 93, 185, 43, 220, 161, 63,
    ...
    fn signs_transaction_for_mumbai() {
        let signatures = &[
            &[
                248, 108, 9, 133, 4, 168, 23, 200, 0, 130, 82, 8, 148, 53, 53, 53, 53, 53, 53, 53,
                53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 53, 136, 13, 224, 182, 179, 167,
                100, 0, 0, 128, 128, 160, 28, 207, 211, 218, 157, 116, 151, 209, 249, 25, 245, 9,
            ...
            &[
                248, 106, 128, 134, 213, 86, 152, 55, 36, 49, 131, 30, 132, 128, 148, 240, 16, 159,
                200, 223, 40, 48, 39, 182, 40, 92, 200, 137, 245, 170, 98, 78, 172, 31, 85, 132,
                59, 154, 202, 0, 128, 1, 160, 75, 9, 70, 21, 191, 87, 78, 224, 147, 37, 63, 237,
    ...
    // //TODO recover these tests if this experiment card works out
