...
pub struct Neighborhood {
    ...
    exit_location: Option<HashSet<ExitLocation>>
}
...
impl Neighborhood {
    ...
    fn handle_exit_location_message(&self, message: UiSetExitLocationRequest, client_id: u64, context_id: u64) {
