...
use crate::accountant::{
    checked_conversion, Accountant, AvailableBalancesAndQualifiedPayables, ReceivedPayments,
...
pub struct AccountantSubs {
    ...
    pub report_our_balances_and_qualified_payables:
        Recipient<AvailableBalancesAndQualifiedPayables>,
