...
use crate::sub_lib::proxy_server::{AddReturnRouteMessage, AddRouteMessage, DEFAULT_MINIMUM_HOP_COUNT};
...
impl ProxyServer {
    ...
    fn handle_normal_client_data(&mut self, msg: InboundClientData, retire_stream_key: bool) {
        ...
        let minimum_hop_count = if self.is_decentralized { DEFAULT_MINIMUM_HOP_COUNT } else { 0 };
