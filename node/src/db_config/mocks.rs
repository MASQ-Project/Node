...
pub struct ConfigDaoMock {
    ...
    set_through_provided_transaction_results: RefCell<Vec<Result<(), ConfigDaoError>>>,
}
...
impl ConfigDao for ConfigDaoMock {
    ...
    fn set_through_provided_transaction(
        ...
        self.set_through_provided_transaction_params
            .lock()
            .unwrap()
...
impl ConfigDaoMock {
    pub fn new() -> Self {
        Self {
            ...
            set_through_provided_transaction_params: Arc::new(Mutex::new(vec![])),
            set_through_provided_transaction_results: RefCell::new(vec![]),
        }
    }
    ...
    pub fn set_through_provided_transaction_params(
        mut self,
        params: &Arc<Mutex<Vec<(ArbitraryIdStamp, String, Option<String>)>>>,
    ) -> Self {
        self.set_through_provided_transaction_params = params.clone();
        self
    }
