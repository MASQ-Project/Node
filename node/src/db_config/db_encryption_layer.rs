...
impl DbEncryptionLayer {
    pub fn password_matches (db_password_opt: &Option<String>, example_encrypted_opt: &Option<String>) -> bool {
    ...
    pub fn decrypt_value (crypt_value_opt: &Option<String>, db_password_opt: &Option<String>, name: &str) -> Result<Option<String>, SecureConfigLayerError> {
    ...
    pub fn encrypt_value (plain_value_opt: &Option<String>, db_password_opt: &Option<String>, name: &str) -> Result<Option<String>, SecureConfigLayerError> {
