...
pub struct BidiHashMap<A, B> where A: Hash + Clone, B: Hash + Clone {
    a_to_b: HashMap<A, B>,
    b_to_a: HashMap<B, A>,
}

impl<A, B> BidiHashMap<A, B> where A: Hash + Eq + Clone, B: Hash + Eq + Clone {
    ...
    pub fn insert(&mut self, a: A, b: B) { // TODO: Possibly return an option of a tuple in case we overwrote something
