...
pub const AMOY_TESTNET_CONTRACT_CREATION_BLOCK: u64 = 999999999999999; //TODO put there th right one once you know it
...
mod tests {
    ...
    fn constants_have_correct_values() {
        ...
        assert_eq!(AMOY_TESTNET_CONTRACT_CREATION_BLOCK, 7777777777);
