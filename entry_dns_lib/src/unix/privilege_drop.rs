...
#[cfg (test)]
mod tests {
    use unix::privilege_drop::PrivilegeDropper;
    use unix::privilege_drop::IdWrapper;
    use unix::privilege_drop::EnvironmentWrapper;
