...
impl StreamConnector for StreamConnectorMock {
    ...
    fn connect_one(&self, _ip_addrs: Vec<IpAddr>, _target_hostname: &String, _target_port: u16, _logger: &Logger) -> Result<ConnectionInfo, io::Error> {
...
impl StreamConnectorMock {
    ...
    pub fn with_connection (self, local_addr: SocketAddr, peer_addr: SocketAddr, reader: ReadHalfWrapperMock, writer: WriteHalfWrapperMock) -> StreamConnectorMock {
        let connection_info = ConnectionInfo {
