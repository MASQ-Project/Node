...
* `exitByteRate`: This parameter indicates an amount of MASQ demanded to process 1 byte of routed payload while the Node acts as
  the exit Node.

* `exitServiceRate`: This parameter indicates an amount of MASQ demanded to provide services, unpacking and repacking 1 CORES
  package, while the Node acts as the exit Node.

* `routingByteRate`: This parameter indicates an amount of MASQ demanded to process 1 byte of routed payload while the Node is a common
  relay Node.
